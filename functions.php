...
function create_post_type_indu() {  
...
add_action( 'init', 'create_post_type_indu' );

function create_post_type_insight() {  
...
add_action( 'init', 'create_post_type_insight' );

function create_post_type_jobopening() {  
...
add_action( 'init', 'create_post_type_jobopening' );
...
function business_point_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Home page about section', 'business-point' ),
		 'id' => 'sidebar-10',
	) );
	register_sidebar( array(
...
function business_point_scripts() {
	...
	wp_enqueue_style( 'boostrap-vendor', get_template_directory_uri() . '/lib/bootstrap/css/bootstrap.min.css');
	...
	wp_enqueue_script( 'boostrap-js', get_template_directory_uri() . '/lib/bootstrap/js/bootstrap.bundle.min.js', array(), '20151215', true );
