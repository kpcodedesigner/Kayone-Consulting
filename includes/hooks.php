            ...
            <div class="container">
                ...
                if( !empty( $top_address ) || !empty( $top_phone ) || !empty( $top_email ) ){ ?>
                    <div class="top-left">
						...
						<div class="social-links" id="top_social_icon">
							  <a href="https://facebook.com/kayoneconsulting" class="facebook"><i class="fa fa-facebook-square"></i></a>
							  <a href="https://www.linkedin.com/company/kayoneconsulting" class="linkedin"><i class="fa fa-linkedin-square"></i></a>
						 </div>
                        ...
                        <?php if( !empty( $top_email ) ){ ?>
                            <span class="fax" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-envelope-o" aria-hidden="true"></i> <?php echo esc_html( $top_email ); ?></span>
                        <?php } ?>
...
if ( ! function_exists( 'business_point_header_action' ) ) :
    ...
    function business_point_header_action() {
        ...
        <div class="head-wrap">
			...
			<form class="form-inline float-right" id="search_nav_bar">
				
			<?php echo do_shortcode('[ivory-search id="6101" title="Primary menu search"]'); ?>	
...
if ( ! function_exists( 'business_point_before_content_action' ) ) :
    ...
    ?><div id="content" class="site-content"><div class="inner-wrapper"><?php
    }
endif;
...
if ( ! function_exists( 'business_point_after_content_action' ) ) :
    ...
    ?></div><!-- .inner-wrapper --></div><!-- .container --><!-- #content --><?php    
    }
endif;
